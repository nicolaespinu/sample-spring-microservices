...
import com.spinic.microservices.api.event.Event;
...
class RecommendationServiceApplicationTests extends MongoDbTestBase {
    ...
    void getRecommendationsByProductId() {
        ...
        sendCreateRecomendationEvent(productId,1);
        sendCreateRecomendationEvent(productId,2);
        sendCreateRecomendationEvent(productId,3);
    ...
    @Disabled("Write operation error on server localhost:51458. Write error: WriteError{code=11000, message='E11000 duplicate key error collection: test.recommendations index: prod-rec-id dup key: { productId: 1, recommendationId: 1 }', details={}}.")
    @Test
    void duplicateError() {
        int productId = 1;
        int recommendationId = 1;

        sendCreateRecomendationEvent(productId, recommendationId);
    ...
    private void sendCreateRecomendationEvent(int productId, int recommendationId) {
        Recommendation recommendation = new Recommendation(productId, recommendationId, "nameAuthor" + recommendationId, recommendationId, "Content " + recommendationId, "SA");
        var event = new Event<>(Event.Type.CREATE, productId, recommendation);
